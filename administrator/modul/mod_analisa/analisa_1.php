    ...
    if ($_SESSION[leveluser]=='admin'){
	 ...
	 <div class="box box-body box-solid">
			...
			?>
			 ...
			 <div class="box box-body box-solid">
				<div class="box-header with-border">
				<h3 class="box-title">MATRIKS BOBOT W</h3>
					<div class="box-tools pull-right">
						<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus">MATRIKS</i></button>
                    </div><!-- /.box-tools -->
				</div>
				<div class="box-body">
							...
							$no=1;
							  while ($r=mysql_fetch_array($tampil_klasifikasi)){
								...
								while ($n=mysql_fetch_array($klasifikasi)){
									...
									$nilaiok = $himpunankriteria['nilai'] / 100;	
										echo "<td>$nilaiok</td>";
			...
			?>
			 ...
			 <div class="box box-body box-solid">
				...
				<h3 class="box-title">NORMALISASI W</h3>
					<div class="box-tools pull-right">
						<button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus">NORMALISASI W</i></button>
                    </div><!-- /.box-tools -->
				</div>
				<div class="box-body">
							...
							$no=1;
							  while ($r=mysql_fetch_array($tampil_klasifikasi)){
								...
								while ($n=mysql_fetch_array($klasifikasi)){
									...
									//$nilaiok = $himpunankriteria['nilai'] / $crmax['nilaimax'] / 100;
									$nilaiok = (pow($himpunankriteria['nilai'],$crmax['nilaimax'])) / 100;	
										echo "<td>$nilaiok</td>";
