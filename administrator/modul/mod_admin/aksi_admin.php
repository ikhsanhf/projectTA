...
elseif ($module=='admin' AND $act=='input_pengajar'){
  ...
  $cek_nip = mysql_query("SELECT * FROM pengajar WHERE kodedosen='$_POST[kodedosen]'");
      ...
      //apabila ada foto yang di upload
        if (!empty($lokasi_file)){
            ...
            window.location=(href='../../media_admin.php?module=admin&act=tambahpengajar')</script>";
                ...
                mysql_query("INSERT INTO pengajar(
								 kodedosen,
                                 nama_lengkap,
                                 username_login,
                                 password_login,
        ...
        $pass=md5($_POST['password']);
        $tgl_lahir=$_POST['thn'].'-'.$_POST['bln'].'-'.$_POST['tgl'];
        mysql_query("INSERT INTO pengajar(kodedosen,
                                 nama_lengkap,
                                 username_login,
                                 password_login,
                                 alamat,
        ...
        header('location:../../media_admin.php?module='.$module.'&act=pengajar');
  }else{
      echo "<script>window.alert('Kode Dosen sudah digunakan.');
                window.location=(href='../../media_admin.php?module=admin&act=tambahpengajar')</script>";
  }
...
elseif ($module=='admin' AND $act=='update_pengajar'){
  ...
  if($_POST['kodedosen']==$ketemu['kodedosen']){
  ...
  elseif(!empty($lokasi_file) AND empty($_POST['password'])){
      if (file_exists($direktori_file)){
            ...
            window.location=(href='../../media_admin.php?module=admin&act=pengajar')</script>";
                ...
                UploadImage($nama_file);
                mysql_query("UPDATE pengajar SET kodedosen  = '$_POST[kodedosen]',
                                  nama_lengkap   = '$_POST[nama_lengkap]',
                                  username_login = '$_POST[username]',
                                  alamat         = '$_POST[alamat]',
                                  tempat_lahir   = '$_POST[tempat_lahir]',
